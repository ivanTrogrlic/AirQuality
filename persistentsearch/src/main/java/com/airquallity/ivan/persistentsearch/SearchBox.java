package com.airquallity.ivan.persistentsearch;
...
import com.airquallity.ivan.persistentsearch.animation.ReverseInterpolator;
import com.airquallity.ivan.persistentsearch.animation.SupportAnimator;
import com.airquallity.ivan.persistentsearch.animation.ViewAnimationUtils;

import java.util.ArrayList;
import java.util.List;

import static com.airquallity.ivan.persistentsearch.MaterialMenuDrawable.IconState.ARROW;
...
//		toggleSearch();
    ...
    private void openSearch(Boolean openKeyboard) {
        if (animateDrawerLogo) {
            this.materialMenu.animateState(ARROW);
